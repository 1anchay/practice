...
<body class="chinese-pattern">
    ...
    <main class="container mx-auto px-6 py-16 max-w-4xl">
        <!-- Header -->
        <header class="terms-header py-20 mb-16">
            <div class="container mx-auto px-6 text-center relative z-10">
                <div class="max-w-3xl mx-auto">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6">Пользовательское соглашение</h1>
                    <p class="text-xl text-red-300">Правила использования нашего сайта и услуг</p>
                </div>
            </div>
        </header>
